...
<div class="rounded-lg border border-primary/20 border-l-4 border-l-indigo-500 bg-surface p-4 shadow-sm dark:border-primary/20 dark:bg-surface-dark">
	<div class="flex gap-4">
		<div class="flex h-24 w-16 flex-shrink-0 items-center justify-center rounded bg-indigo-100 text-indigo-400 dark:bg-indigo-900/30 dark:text-indigo-500">
		...
		<div class="min-w-0 flex-1">
			...
			<div class="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-500 dark:text-gray-400">
				<span class="rounded bg-indigo-100 px-1.5 py-0.5 font-medium text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-400">transcoding</span>
				{#if job.started_at}
