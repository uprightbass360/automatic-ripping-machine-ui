...
class Job(Base):
    ...
    artist_auto = Column(String(256))
    artist_manual = Column(String(256))
    album = Column(String(256))
    album_auto = Column(String(256))
    album_manual = Column(String(256))
    season = Column(String(10))
    season_auto = Column(String(10))
    season_manual = Column(String(10))
    episode = Column(String(10))
    episode_auto = Column(String(10))
    episode_manual = Column(String(10))
